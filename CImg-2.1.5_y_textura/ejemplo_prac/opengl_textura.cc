...
// // OBJETO A DIBUJAR Ejemplo primero de clase
// GLfloat vertices[] = {0, 0, 0, //Al punto 0, 0, 0 de la figura le corresponde el 0, 1 de la imagen
// 		      10, 0, 0, //Al punto 10, 0, 0 de la figura le corresponde el 1, 1 de la imagen
// 		      10, 5, 0,
// 		      0, 5, 0};
